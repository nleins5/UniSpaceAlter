...
def build_perfect_back_with_collar():
    ...
    # Back Collar Polygon
    # The back lower curve goes from 97,14 to 184,14.
    # Looking at v_raglan_back_grid.png, the back collar lower curve is basically just a very shallow arc.
    collar_bottom_curve = [
        (97, 14), (105, 25), (115, 32), (125, 36), (140, 38), 
        (155, 36), (165, 32), (175, 25), (184, 14)
    ]
    collar_polygon = collar_bottom_curve + [(184, 0), (97, 0)]
    ...
    print("Masks updated in public/mockups with collar included")
...
build_perfect_back_with_collar()
