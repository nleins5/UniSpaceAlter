      ...
      <section className="home-hero" ref={heroRef}>
        ...
        <div className="hero-content">
          ...
          <div className="hero-actions scroll-reveal">
            <a href="https://www.facebook.com/UniSpaceTramdongphuc" target="_blank" rel="noopener noreferrer" className="hero-btn-primary">
        ...
        <div className="home-container">
          ...
          <div className="pricing-grid">
            <div className="pricing-card scroll-reveal">
              ...
              <a href="https://www.facebook.com/UniSpaceTramdongphuc" target="_blank" rel="noopener noreferrer" className="pricing-btn">Nhắn tin đặt hàng</a>
            </div>
            ...
            <div className="pricing-card pricing-card-pop scroll-reveal">
              ...
              <a href="https://www.facebook.com/UniSpaceTramdongphuc" target="_blank" rel="noopener noreferrer" className="pricing-btn-pop">Nhắn tin đặt hàng</a>
            </div>
      ...
      <footer className="home-footer">
        <div className="home-container">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              <h4>Hỗ trợ</h4>
              <a href="https://www.facebook.com/UniSpaceTramdongphuc" target="_blank" rel="noopener noreferrer">Nhắn tin Facebook</a>
